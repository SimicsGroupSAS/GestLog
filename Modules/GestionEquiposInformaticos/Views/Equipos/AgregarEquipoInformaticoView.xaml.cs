    ...
    public partial class AgregarEquipoInformaticoView : Window
    {
        ...
        public AgregarEquipoInformaticoView()
        {
            ...
            var logger = serviceProvider.GetRequiredService<GestLog.Services.Core.Logging.IGestLogLogger>();
              var viewModel = new GestLog.Modules.GestionEquiposInformaticos.ViewModels.Equipos.AgregarEquipoInformaticoViewModel(
        ...
        }        private void BtnCancelar_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                if (DataContext is GestLog.Modules.GestionEquiposInformaticos.ViewModels.Equipos.AgregarEquipoInformaticoViewModel vm)
                {
