...
namespace GestLog.Migrations
{
    ...
    [Migration("20251215162233_AgregarTablaMantenimientosCorrectivos")]
    partial class AgregarTablaMantenimientosCorrectivos
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GestLog.Modules.GestionEquiposInformaticos.Models.Entities.MantenimientoCorrectivoEntity", b =>
                {
                    ...
                    b.Property<string>("EquipoInformaticoCodigo")
                        .HasColumnType("nvarchar(20)");

                    b.Property<int?>("EquipoInformaticoId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PerifericoEquipoInformaticoCodigo")
                        .HasColumnType("nvarchar(50)");

                    b.Property<int?>("PerifericoEquipoInformaticoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EquipoInformaticoCodigo");

                    b.HasIndex("PerifericoEquipoInformaticoCodigo");
            ...
            modelBuilder.Entity("GestLog.Modules.GestionEquiposInformaticos.Models.Entities.MantenimientoCorrectivoEntity", b =>
                {
                    b.HasOne("GestLog.Modules.GestionEquiposInformaticos.Models.Entities.EquipoInformaticoEntity", "EquipoInformatico")
                        .WithMany()
                        .HasForeignKey("EquipoInformaticoCodigo");

                    b.HasOne("GestLog.Modules.GestionEquiposInformaticos.Models.Entities.PerifericoEquipoInformaticoEntity", "PerifericoEquipoInformatico")
                        .WithMany()
                        .HasForeignKey("PerifericoEquipoInformaticoCodigo");

                    b.Navigation("EquipoInformatico");

                    b.Navigation("PerifericoEquipoInformatico");
                });
